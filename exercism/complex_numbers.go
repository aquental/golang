...
func (n1 Number) Divide(n2 Number) Number {
	return Number{
		(n1.real*n2.real + n1.imaginary*n2.imaginary) / (n2.real*n2.real + n2.imaginary*n2.imaginary),
...
func (n Number) Exp() Number {
	return Number{
		math.Exp(n.real) * math.Cos(n.imaginary),
		math.Exp(n.real) * math.Sin(n.imaginary),
	}
}
